...
def wordy_pyramid():
    pyramid_list = list_of_words_with_lengths(range(3, 21, 2)) + list_of_words_with_lengths(range(20, 3, -2))
    return pyramid_list
...
def list_of_words_with_lengths(list_of_lengths):
    words = [get_a_word_of_length_n(length) for length in list_of_lengths]
